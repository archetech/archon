...
| `ARCHON_GATEKEEPER_GC_INTERVAL`     | 60       | The number of minutes between garbage collection cycles (0 to disable) |
| `ARCHON_GATEKEEPER_STATUS_INTERVAL` |  1       | The number of minutes between logging status updates (0 to disable)    |
