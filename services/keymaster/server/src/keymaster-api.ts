...
import { createAddressTailRouter } from './keymaster-address-tail-router.js';
...
import { createCredentialWorkflowRouter } from './keymaster-credential-workflow-router.js';
...
v1router.use(createAddressTailRouter(routerOptions));
...
v1router.use(createCredentialWorkflowRouter(routerOptions));
