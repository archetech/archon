...
export default class WalletSQLite extends AbstractBase {
    ...
    constructor(walletFileName: string = 'wallet.db', dataFolder: string = 'data') {
        ...
        // joining it would give `data//home/you/...`, which opens nothing
        // anyone asked for. Callers in this repo split a path first, so this
        // guards the published constructor against being handed one whole.
