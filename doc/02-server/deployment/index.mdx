...
Archon is a suite of software tools, libraries, and services that implement the Archon Identity Protocol as defined and documented by the [CID DID Scheme](https://archetech.github.io/archon/docs/protocol/scheme). This document refers to the [Archon v0.1.0 release](https://github.com/archetech/archon/releases/tag/TBD).

There are countless ways to deploy Archon technology. These guidelines reflect current lessons learned and best practices. Feedback, recommendations, and additional best practices are welcome. Recommendations can be sent by opening an [issue](https://github.com/archetech/archon/issues) against this document to share your experience with Archon; these may be incorporated in future versions of this document. You can also comment diretly at the bottom of any docs page, provided you have a GitHub account.
...
- kc-BTC/signet-mediator-1 is the Archon Mediator for [Bitcoin Signet](https://en.bitcoin.it/wiki/Signet)
- kc-BTC/testnet4-mediator-1 is the Archon Mediator for [Bitcoin Testnet](https://github.com/bitcoin/)
- kc-BTC/signet-node is a generic Bitcoin Signet node
...
| `ARCHON_GATEKEEPER_REGISTRIES` | `hyperswarm,BTC/testnet4,BTC/signet` | List of DID registries supported by this node. `TESS` is deprecated and can be removed if present    |
...
Archon uses immutable ledgers to record evidence of a decentralized consensus on the order of operations that form the history of a DID. The Archon protocol is blockchain agnostic and provides 2 Testnet examples to demonstrate the protocol's portability: Bitcoin Testnet4 and Bitcoin Signet. Each DID is registered on a blockchain selected by the end-user at the time of creation. DID operations are batched and exported by the Archon Mediator to its associated blockchain node.

In the example below, we use a generic bitcoin-core node configured to operate on testnet4. A similar service configuration block for Bitcoin Signet is provided in the `kc` repository:
...
On the first run, the `start-node` command will take up to 30 minutes to prepare the docker containers needed by the Archon node. This will include Bitcoin Testnet and Bitcoin Signet as registries. Full network sync time may take many hours.
...
Oct 16 18:11:49 archon-gatekeeper start-node[3151048]: gatekeeper-1     | Supported registries: hyperswarm,BTC/testnet4,BTC/signet,Signet
...
Archon supports multiple decentralized registries: Bitcoin mainnet, Signet, and Testnet4. More registries will become available over time. Decentralized registries are an important part of decentralizing identity; the registry contains the consensus on order of Archon operations.
...
The `BTC/testnet4-cli` script passes the command line arguments to the standard bitcoin node wallet operating inside the `BTC/testnet4-node` docker container. The commands above should also be replicated for other supported blockchains (ex: `./scripts/BTC/signet-cli`).
...
Oct 28 16:34:14 archon-gatekeeper start-node[703548]: #4 [BTC/signet-node internal] load build definition from Dockerfile.sat
...
Oct 28 16:34:14 archon-gatekeeper start-node[703710]:  Container kc-BTC/signet-node-1  Created
Oct 28 16:34:14 archon-gatekeeper start-node[703710]:  Container kc-BTC/testnet4-node-1  Created
Oct 28 16:34:14 archon-gatekeeper start-node[703710]:  Container kc-BTC/signet-mediator-1  Created
Oct 28 16:34:14 archon-gatekeeper start-node[703710]:  Container kc-BTC/testnet4-mediator-1  Created
Oct 28 16:34:14 archon-gatekeeper start-node[703710]: Attaching to gatekeeper-1, hyperswarm-1, keymaster-1, mongodb-1, BTC/testnet4-mediator-1, BTC/testnet4-node-1, BTC/signet-mediator-1, BTC/signet-node-1
```
...
```log
...
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 59 did:cid:z3v8AuaZDB5DyvYMXkaZBijtaoUZEAQVHShuffr6dRWtQmnL62W OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 60 did:cid:z3v8AuaZjo9EKqTJLSW9DGTXFerRjCsH9Fp3Pmnv35F6njZm7aB OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 61 did:cid:z3v8AuaUkujpZggLmWFG7DFqL5gmCo9bner2RZU8cD5EPwZcv8N OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 62 did:cid:z3v8AuaWK2415KF3vaMLuGdizvzPSzcpzeRPKBykoAcK1twXwhP OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 63 did:cid:z3v8AuaX8nDuXtLHrLAGmgfeVwCGfX9nMmZPTVbCDfaoiGvLuTv OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 64 did:cid:z3v8AuabChKbzYnyw8TDH8wUzeVQa2AQGLGP32q27emzepDjQ3d OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 65 did:cid:z3v8Auacu1CNBsHcadzwm2SYwkLMEuSeHhhncpUhhRKqZfL3tMP OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 66 did:cid:z3v8AuadTptkdez7A2DoNjMRcqzUEVzQvBaUDLL9ufKTWskk87o OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 67 did:cid:z3v8AuaiV29JNgqgVeaVrNj51rQu9YtkWgpuezkjWeUUqxsi6WA OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 68 did:cid:z3v8AuaUqS7xVKXJCbkYHFt7qijszix3T39wVxUXL29P46YE2gu OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 69 did:cid:z3v8AuahGKB5bJgCY4kvFGdKCyNP8QgM47Yd2tzcEUsN6EkygUn OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 70 did:cid:z3v8AuaesXqNNmMENhZSuQSeqGbKdy5cogDUPduzWgdhnvKb5jF OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 71 did:cid:z3v8AuagPcWQffRpfE7oHxccQVJAdk4sk4oNW6SAjPYD3syNAa8 OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 72 did:cid:z3v8AuaW5UNaQ9u5bd4m6QX4aL82bP9cfuh93ZgvyryzhkjkGs9 OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 73 did:cid:z3v8AuaTDz8s7wBZwhKcfnV59wEq2JoEi2FbcJJrE576AKuDvTa OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 74 did:cid:z3v8Auai62TXdGDf3rnXHENaDzYM7NAdFeiz8kDhRV7Ch1L8FHv OK
Oct 28 16:34:20 archon-gatekeeper start-node[703710]: gatekeeper-1     | 75 did:cid:z3v8AuaYGdCpWyLKfcoP2if1CDTA74zGnh1VDReXuhe5zY3pSdt OK
...
Oct 28 16:35:30 archon-gatekeeper start-node[705212]: gatekeeper-1     | 6987 did:cid:z3v8AuaiDEX5skrxB1bHH4aE5Jp6QcubQ7gqnpPWwFpedVSxtsF OK
...
Oct 28 16:35:30 archon-gatekeeper start-node[705212]: gatekeeper-1     | Supported registries: hyperswarm,BTC/testnet4,BTC/signet
...
Oct 28 16:35:35 archon-gatekeeper start-node[705212]: gatekeeper-1     | GET /api/v1/did/did:cid:z3v8AuaebRuWwQNHLvSXPD59KoTqTky7cvDSJ88Tnjf9gp2ULTe 200 - 28.696 ms
...
Oct 28 16:35:35 archon-gatekeeper start-node[705212]: keymaster-1      |         ],
Oct 28 16:35:35 archon-gatekeeper start-node[705212]: keymaster-1      |         "id": "did:cid:z3v8AuaebRuWwQNYLvSXPDIKoTqTky7cvDSJ88Tnjf9gp2ULTe",
...
Oct 28 16:35:35 archon-gatekeeper start-node[705212]: keymaster-1      |                 "controller": "did:cid:z3v8AuaebRuWwQNYLvSXPDIKoTqTky7cvDSJ88Tnjf9gp2ULTe",
...
Oct 28 16:35:35 archon-gatekeeper start-node[705212]: keymaster-1      |     "didDocumentRegistration": {
Oct 28 16:35:35 archon-gatekeeper start-node[705212]: keymaster-1      |         "version": 1,
...
The `kc/docker-compose.yml` script will launch Bitcoin Testnet4 and Signet nodes to be used as DID registries.
...
Oct 28 16:37:05 archon-gatekeeper start-node[706734]: BTC/testnet4-node-1      | 2024-10-28T16:37:05.651173Z init message: Verifying blocks…
...
Oct 28 16:37:15 archon-gatekeeper start-node[706734]: BTC/testnet4-mediator-1  |         "did": "did:cid:z3v8AuabA1TdC1GDvGoYkEXsESoJThCyuRekbn3fELkeGSGJa1e",
...
bitcoin-core:signet      38333/tcp kc-BTC/signet-node-1
```
