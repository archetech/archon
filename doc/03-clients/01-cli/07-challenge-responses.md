...
The challenge is created from a schema file or from an existing DID pointing to an existing schema credential. To create a challenge from a schema file, use `archon create-challenge`; to create a challenge from an existing credential DID, use `archon create-challenge-cc` instead.

```sh
$ archon create-challenge-cc social-media sm-challenge
...
$ archon resolve-did sm-challenge
{
    ...
    "didDocument": {
        ...
        "id": "did:cid:test:z3v8AuaaxRxwZCPUnpCc4RoV5CZjeYVJepmJTVeJrpvyyB6LmwN",
    ...
    "didDocumentData": {
        "credentials": [
            {
                "schema": "did:cid:test:z3v8AuaeAPf9JMuyYZ1D79D626uUzDQmRPwq4d8oB1Th6ztzAS7"
            }
        ]
    },
...
1. Then the user can create a repsonse:
    ...
    ```sh
    $ archon create-response sm-challenge
    did:cid:test:z3v8AuadZ56m4x2UTpeY3HhSFvFQnrCUyASBYA77vqrqQr9SR99
    ```
...
$ archon use-id Alice
OK
archon verify-response did:cid:test:z3v8AuadZ56m4x2UTpeY3HhSFvFQnrCUyASBYA77vqrqQr9SR99 did:cid:test:z3v8AuaaxRxwZCPUnpCc4RoV5CZjeYVJepmJTVeJrpvyyB6LmwN
[
    {
        "@context": [
