...
Commands:
  ...
  add-vault-item <id> <file>         Add an item (file) to a group vault
  add-vault-member <id> <member>     Add a member to a group vault
  ...
  create-vault [options]             Create a group vault
  ...
  get-vault-item <id> <item> <file>  Save an item from a group vault to a file
  ...
  list-vault-items <id>              List items in the group vault
  list-vault-members <id>            List members of a group vault
  ...
  remove-vault-item <id> <item>      Remove an item from a group vault
  remove-vault-member <id> <member>  Remove a member from a group vault
