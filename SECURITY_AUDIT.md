...
| H-09 | 🟠 High | Infra | Bitcoin signet RPC port exposed to all interfaces | `docker/docker-compose.btc-signet.yml` |
...
**Affected:** `docker/docker-compose.btc-signet.yml`
...
- `docker/docker-compose.btc-testnet4.yml`
