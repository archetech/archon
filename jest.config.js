const config = {
    ...
    moduleNameMapper: {
        ...
        '^\\.\\/errors\\.js$': '<rootDir>/services/drawbridge/server/src/errors.ts',
        '^\\.\\/types\\.js$': '<rootDir>/services/drawbridge/server/src/types.ts',
        ...
        '^\\.\\./errors\\.js$': '<rootDir>/services/drawbridge/server/src/errors.ts',
        '^\\.\\./types\\.js$': '<rootDir>/services/drawbridge/server/src/types.ts',
        '^\\.\\./macaroon\\.js$': '<rootDir>/services/drawbridge/server/src/macaroon.ts',
        '^\\.\\./rate-limiter\\.js$': '<rootDir>/services/drawbridge/server/src/rate-limiter.ts',
        '^\\.\\./lightning-mediator-client\\.js$': '<rootDir>/services/drawbridge/server/src/lightning-mediator-client.ts',
        '^\\.\\./pricing\\.js$': '<rootDir>/services/drawbridge/server/src/pricing.ts',
