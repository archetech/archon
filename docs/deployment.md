...
```yaml
# include:
#   - docker/docker-compose.btc-mainnet.yml
#   - docker/docker-compose.btc-signet.yml
#   - docker/docker-compose.lightning.yml
#   - docker/docker-compose.drawbridge.yml
#   - docker/docker-compose.zcash-mainnet.yml
```
...
|------|---------|-------------|
| `docker/docker-compose.btc-mainnet.yml` | BTC mainnet | **You provide** — requires an external Bitcoin Core node with RPC access |
| `docker/docker-compose.btc-signet.yml` | BTC signet | Bundled — runs its own `bitcoin-core` container |
| `docker/docker-compose.btc-testnet4.yml` | BTC testnet4 | Bundled — runs its own `bitcoin-core` container |
...
If you do not enable `docker/docker-compose.zcash-mainnet.yml`, you can still delegate confirmed Zcash resolution to another Gatekeeper node that does track `ZEC:mainnet`:
