...
Default `ARCHON_PROTOCOL` is `/ARCHON/v0.13-beta`. All nodes that want to peer
...
| `ARCHON_PROTOCOL` | `/ARCHON/v0.13-beta` | Hyperswarm topic seed. Must match peers you want to talk to. |
