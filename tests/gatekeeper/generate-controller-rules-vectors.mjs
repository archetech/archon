...
const cases=[
    ...
    ['agent changes type',await update(a,createA,{didDocumentRegistration:{type:'asset'},didDocument:{...root,controller:b}}),false],
    ['asset changes type',await update(asset,createAsset,{didDocumentRegistration:{type:'agent'},didDocument:{...root,id:asset}}),false],
