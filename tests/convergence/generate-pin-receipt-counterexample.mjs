...
for (const legacy of [false, true]) {
    ...
    vectors.push({ legacy, did, assetDid: 'did:cid:' + await cid(asset), asset: hint(asset), events,
        orders: [[0, 1, 2, 3, 4], [1, 0, 2, 3, 4]] });
}
writeFileSync('tests/convergence/pin-receipt-counterexample.json', JSON.stringify(vectors, null, 2) + '\n');
