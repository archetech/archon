...
ARCHON_FTC_T5_HOST=localhost
ARCHON_FTC_T5_START_BLOCK=0
ARCHON_FTC_T5_PORT=19337
ARCHON_FTC_T5_USER=feathercoin
ARCHON_FTC_T5_PASS=feathercoin
ARCHON_FTC_T5_WALLET=archon
ARCHON_FTC_T5_IMPORT_INTERVAL=1
ARCHON_FTC_T5_EXPORT_INTERVAL=1
ARCHON_FTC_T5_FEE_BLOCK_TARGET=1
ARCHON_FTC_T5_FEE_FALLBACK_SAT_BYTE=10
ARCHON_FTC_T5_FEE_MAX=0.00003000
ARCHON_FTC_T5_RBF_ENABLED=false
ARCHON_FTC_T5_REIMPORT=true
ARCHON_FTC_T5_DB=json
