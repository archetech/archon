...
- When proxying end-user authenticated Herald requests through Drawbridge, never overwrite the caller's `Authorization` header with an internal admin key. Use a dedicated internal header instead.
