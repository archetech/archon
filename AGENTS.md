...
- Server-side Keymaster should keep `ARCHON_GATEKEEPER_URL` pointed at raw Gatekeeper for full API coverage; when gateway features need Drawbridge, set `ARCHON_NODE_URL` to the Drawbridge base URL.
