...
- Filecoin auxiliary storage pinning is opt-in by registry through `ARCHON_GATEKEEPER_REGISTRIES_PIN`; keep local and ephemeral DIDs out of Filecoin pin queues by default because Filecoin storage has ongoing payment cost.
